...
* **seperate algorithm from file I/O**: this will make cython binding easier to code by avoiding the need of patching the C++ code. This is standard good practice in programming.
